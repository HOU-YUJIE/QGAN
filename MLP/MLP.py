...
# Training file paths
TRAIN_FILES = {
    "Baseline": "./VQC/selected_features_train.csv", 
    "CTGAN Augmented": "./MLP/Train_Balanced_CTGAN.csv",
    "QGAN Augmented": "./VQC/Train_Balanced_QGAN.csv"
}

# Real test set
TEST_FILE = "./VQC/selected_features_test.csv"
...
def train_and_evaluate(train_path, test_path, experiment_name):
    ...
    cm_save_path = f"./MLP/CM_{experiment_name.replace(' ', '_')}.png"
...
if __name__ == "__main__":
    ...
    # Save image
    plt.savefig("./MLP/Experiment_Comparison_Chart.png", dpi=300)
    print("\nExperiment comparison chart saved to: ./MLP/Experiment_Comparison_Chart.png")
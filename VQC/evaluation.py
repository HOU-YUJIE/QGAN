...
def calculate_statistical_metrics(df_real, df_synthetic, columns, output_dir):
    ...
    avg_ks = metrics_df['KS_Statistic'].mean()
    print(f"\n[Overall average KS difference]: {avg_ks:.4f} (< 0.1 is excellent)")
...
if __name__ == "__main__":
    ...
    for category in range(1, 10):
        ...
        try:
            ...
            metrics_df, avg_ks = calculate_statistical_metrics(df_real, df_synthetic, common_cols, output_dir)
            ...
            with open(report_path, 'w') as f:
                ...
                f.write(f"Average KS Statistic: {avg_ks:.4f}\n\n")
